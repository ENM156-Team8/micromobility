...
class VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel.parse_obj({
