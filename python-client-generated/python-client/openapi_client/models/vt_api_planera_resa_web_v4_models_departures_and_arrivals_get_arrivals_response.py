...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse(BaseModel):
    """
    The response to a get arrivals request, includes the results and pagination information.  # noqa: E501
    """
    results: Optional[conlist(VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel)] = Field(None, description="The results.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse:
        """Create an instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse.parse_obj({
            "results": [VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
