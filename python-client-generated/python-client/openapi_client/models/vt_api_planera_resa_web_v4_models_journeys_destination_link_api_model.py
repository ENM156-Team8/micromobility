...
class VTApiPlaneraResaWebV4ModelsJourneysDestinationLinkApiModel(BaseModel):
    """
    Information about a walk, bike or car link from origin to destination.  # noqa: E501
    """
    ...
    origin: Optional[VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel] = None
    destination: Optional[VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneysDestinationLinkApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneysDestinationLinkApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneysDestinationLinkApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneysDestinationLinkApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneysDestinationLinkApiModel.parse_obj({
            "transport_mode": obj.get("transportMode"),
            "transport_sub_mode": obj.get("transportSubMode"),
            "origin": VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel.from_dict(obj.get("origin")) if obj.get("origin") is not None else None,
            "destination": VTApiPlaneraResaWebV4ModelsJourneysLinkEndpointApiModel.from_dict(obj.get("destination")) if obj.get("destination") is not None else None,
