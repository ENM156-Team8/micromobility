...
class VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel.parse_obj({
