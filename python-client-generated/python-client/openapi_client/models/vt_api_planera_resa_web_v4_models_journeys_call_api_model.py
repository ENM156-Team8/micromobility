...
class VTApiPlaneraResaWebV4ModelsJourneysCallApiModel(BaseModel):
    """
    Information about a call on the trip leg.  # noqa: E501
    """
    stop_point: VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel = Field(..., alias="stopPoint")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneysCallApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneysCallApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneysCallApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneysCallApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneysCallApiModel.parse_obj({
            "stop_point": VTApiPlaneraResaWebV4ModelsJourneysStopPointApiModel.from_dict(obj.get("stopPoint")) if obj.get("stopPoint") is not None else None,
