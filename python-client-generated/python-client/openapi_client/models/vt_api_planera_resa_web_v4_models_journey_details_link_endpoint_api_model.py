...
class VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel.parse_obj({
            "gid": obj.get("gid"),
            "name": obj.get("name"),
