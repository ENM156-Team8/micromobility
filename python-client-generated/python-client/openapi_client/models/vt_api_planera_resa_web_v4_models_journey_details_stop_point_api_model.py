...
class VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel(BaseModel):
    """
    ...
    longitude: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The longitude coordinate of the stop point.")
    stop_area: Optional[VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel] = Field(None, alias="stopArea")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel.parse_obj({
            "gid": obj.get("gid"),
            "name": obj.get("name"),
            "platform": obj.get("platform"),
            "latitude": obj.get("latitude"),
            "longitude": obj.get("longitude"),
            "stop_area": VTApiPlaneraResaWebV4ModelsJourneyDetailsStopAreaApiModel.from_dict(obj.get("stopArea")) if obj.get("stopArea") is not None else None
        })
        return _obj
