...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel(BaseModel):
    """
    ...
    __properties = ["serviceJourneys", "occupancy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel.parse_obj({
