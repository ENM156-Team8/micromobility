...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetDeparturesResponse(BaseModel):
    """
    The response to a get departures request, includes the results and pagination information.  # noqa: E501
    """
    results: Optional[conlist(VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel)] = Field(None, description="The results.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetDeparturesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetDeparturesResponse:
        """Create an instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetDeparturesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetDeparturesResponse.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetDeparturesResponse.parse_obj({
            "results": [VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
