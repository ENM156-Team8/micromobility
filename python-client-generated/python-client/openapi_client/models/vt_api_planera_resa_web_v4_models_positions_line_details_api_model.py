...
class VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel.parse_obj({
            "name": obj.get("name"),
