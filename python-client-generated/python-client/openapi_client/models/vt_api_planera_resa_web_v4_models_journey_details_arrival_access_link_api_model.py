...
class VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel(BaseModel):
    """
    Information about a walk, bike or car link from last public transport trip leg to destination.  # noqa: E501
    """
    ...
    origin: Optional[VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel] = None
    destination: Optional[VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneyDetailsArrivalAccessLinkApiModel.parse_obj({
            "transport_mode": obj.get("transportMode"),
            "transport_sub_mode": obj.get("transportSubMode"),
            "origin": VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel.from_dict(obj.get("origin")) if obj.get("origin") is not None else None,
            "destination": VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel.from_dict(obj.get("destination")) if obj.get("destination") is not None else None,
