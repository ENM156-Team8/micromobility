...
class MicrosoftAspNetCoreMvcProblemDetails(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MicrosoftAspNetCoreMvcProblemDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MicrosoftAspNetCoreMvcProblemDetails:
        """Create an instance of MicrosoftAspNetCoreMvcProblemDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MicrosoftAspNetCoreMvcProblemDetails.parse_obj(obj)

        _obj = MicrosoftAspNetCoreMvcProblemDetails.parse_obj({
            "type": obj.get("type"),
            "title": obj.get("title"),
