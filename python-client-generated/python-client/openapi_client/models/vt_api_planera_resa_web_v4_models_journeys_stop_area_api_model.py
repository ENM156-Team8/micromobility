...
class VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel(BaseModel):
    """
    ...
    tariff_zone1: Optional[VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel] = Field(None, alias="tariffZone1")
    tariff_zone2: Optional[VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel] = Field(None, alias="tariffZone2")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneysStopAreaApiModel.parse_obj({
            "gid": obj.get("gid"),
            "name": obj.get("name"),
            "latitude": obj.get("latitude"),
            "longitude": obj.get("longitude"),
            "tariff_zone1": VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel.from_dict(obj.get("tariffZone1")) if obj.get("tariffZone1") is not None else None,
            "tariff_zone2": VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel.from_dict(obj.get("tariffZone2")) if obj.get("tariffZone2") is not None else None
        })
        return _obj
