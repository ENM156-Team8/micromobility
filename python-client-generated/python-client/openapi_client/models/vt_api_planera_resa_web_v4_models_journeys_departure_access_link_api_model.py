...
class VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneysDepartureAccessLinkApiModel.parse_obj({
