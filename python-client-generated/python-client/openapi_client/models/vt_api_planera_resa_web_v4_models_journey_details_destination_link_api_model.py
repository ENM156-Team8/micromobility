...
class VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel.parse_obj({
