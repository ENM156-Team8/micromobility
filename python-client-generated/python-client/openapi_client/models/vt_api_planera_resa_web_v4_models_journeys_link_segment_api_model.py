...
class VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel.parse_obj({
            "name": obj.get("name"),
