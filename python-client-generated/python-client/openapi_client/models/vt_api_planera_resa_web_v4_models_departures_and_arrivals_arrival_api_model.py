...
class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel(BaseModel):
    """
    ...
    __properties = ["detailsReference", "serviceJourney", "stopPoint", "plannedTime", "estimatedTime", "estimatedOtherwisePlannedTime", "isCancelled", "isPartCancelled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel.parse_obj({
