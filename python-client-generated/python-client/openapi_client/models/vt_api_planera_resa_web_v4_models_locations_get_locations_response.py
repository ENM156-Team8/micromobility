...
class VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse(BaseModel):
    """
    The response to a get locations request, includes the results and pagination information.  # noqa: E501
    """
    results: Optional[conlist(VTApiPlaneraResaWebV4ModelsLocationsLocationApiModel)] = Field(None, description="The results.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse:
        """Create an instance of VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse.parse_obj({
            "results": [VTApiPlaneraResaWebV4ModelsLocationsLocationApiModel.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
