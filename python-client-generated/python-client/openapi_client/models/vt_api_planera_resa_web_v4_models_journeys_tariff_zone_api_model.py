...
class VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel:
        """Create an instance of VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel.parse_obj(obj)

        _obj = VTApiPlaneraResaWebV4ModelsJourneysTariffZoneApiModel.parse_obj({
            "gid": obj.get("gid"),
            "name": obj.get("name"),
