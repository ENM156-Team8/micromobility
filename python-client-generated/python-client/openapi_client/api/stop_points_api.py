...
class StopPointsApi:
    ...
    @validate_arguments
    def stop_points_stop_point_gid_arrivals_details_reference_details_get(self, details_reference : Annotated[StrictStr, Field(..., description="The reference to the service journey, received from the arrivals call. A detailsReference is only valid during the same day as it was generated.")], stop_point_gid : StrictStr, includes : Annotated[Optional[conlist(VTApiPlaneraResaWebV4ModelsArrivalDetailsIncludeType)], Field(description="The additional information to include in the response.")] = None, **kwargs) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalDetailsApiModel:  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_arrivals_details_reference_details_get(details_reference, stop_point_gid, includes, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the stop_points_stop_point_gid_arrivals_details_reference_details_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.stop_points_stop_point_gid_arrivals_details_reference_details_get_with_http_info(details_reference, stop_point_gid, includes, **kwargs)  # noqa: E501

    @validate_arguments
    def stop_points_stop_point_gid_arrivals_details_reference_details_get_with_http_info(self, details_reference : Annotated[StrictStr, Field(..., description="The reference to the service journey, received from the arrivals call. A detailsReference is only valid during the same day as it was generated.")], stop_point_gid : StrictStr, includes : Annotated[Optional[conlist(VTApiPlaneraResaWebV4ModelsArrivalDetailsIncludeType)], Field(description="The additional information to include in the response.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Returns details about an arrival.  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_arrivals_details_reference_details_get_with_http_info(details_reference, stop_point_gid, includes, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method stop_points_stop_point_gid_arrivals_details_reference_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['stop_point_gid']:
            _path_params['stopPointGid'] = _params['stop_point_gid']
    ...
    def stop_points_stop_point_gid_arrivals_get(self, stop_point_gid : Annotated[StrictStr, Field(..., description="The 16-digit Västtrafik gid of the stop point.")], start_date_time : Annotated[Optional[StrictStr], Field(description="The start of the time interval for which to get upcoming arrivals. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.")] = None, time_span_in_minutes : Annotated[Optional[StrictInt], Field(description="The number of minutes from the start time for which to get upcoming arrivals. Allowed values are between 0 and 1440.")] = None, max_arrivals_per_line_and_direction : Annotated[Optional[StrictInt], Field(description="The maximum number of arrivals for a single line in a specific direction.")] = None, limit : Annotated[Optional[StrictInt], Field(description="The number of results to return.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The zero-based start offset of the pagination.")] = None, direction_gid : Annotated[Optional[StrictStr], Field(description="Filter result by last stop on journey. Must be a 16-digit Västtrafik stop area")] = None, **kwargs) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse:  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_arrivals_get(stop_point_gid, start_date_time, time_span_in_minutes, max_arrivals_per_line_and_direction, limit, offset, direction_gid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the stop_points_stop_point_gid_arrivals_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.stop_points_stop_point_gid_arrivals_get_with_http_info(stop_point_gid, start_date_time, time_span_in_minutes, max_arrivals_per_line_and_direction, limit, offset, direction_gid, **kwargs)  # noqa: E501

    @validate_arguments
    def stop_points_stop_point_gid_arrivals_get_with_http_info(self, stop_point_gid : Annotated[StrictStr, Field(..., description="The 16-digit Västtrafik gid of the stop point.")], start_date_time : Annotated[Optional[StrictStr], Field(description="The start of the time interval for which to get upcoming arrivals. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.")] = None, time_span_in_minutes : Annotated[Optional[StrictInt], Field(description="The number of minutes from the start time for which to get upcoming arrivals. Allowed values are between 0 and 1440.")] = None, max_arrivals_per_line_and_direction : Annotated[Optional[StrictInt], Field(description="The maximum number of arrivals for a single line in a specific direction.")] = None, limit : Annotated[Optional[StrictInt], Field(description="The number of results to return.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The zero-based start offset of the pagination.")] = None, direction_gid : Annotated[Optional[StrictStr], Field(description="Filter result by last stop on journey. Must be a 16-digit Västtrafik stop area")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Returns arrivals to the specified stop point at the specified time.  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_arrivals_get_with_http_info(stop_point_gid, start_date_time, time_span_in_minutes, max_arrivals_per_line_and_direction, limit, offset, direction_gid, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method stop_points_stop_point_gid_arrivals_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def stop_points_stop_point_gid_departures_details_reference_details_get(self, details_reference : Annotated[StrictStr, Field(..., description="The reference to the service journey, received from the departures call. A detailsReference is only valid during the same day as it was generated.")], stop_point_gid : StrictStr, includes : Annotated[Optional[conlist(VTApiPlaneraResaWebV4ModelsDepartureDetailsIncludeType)], Field(description="The additional information to include in the response.")] = None, **kwargs) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureDetailsApiModel:  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_departures_details_reference_details_get(details_reference, stop_point_gid, includes, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the stop_points_stop_point_gid_departures_details_reference_details_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.stop_points_stop_point_gid_departures_details_reference_details_get_with_http_info(details_reference, stop_point_gid, includes, **kwargs)  # noqa: E501

    @validate_arguments
    def stop_points_stop_point_gid_departures_details_reference_details_get_with_http_info(self, details_reference : Annotated[StrictStr, Field(..., description="The reference to the service journey, received from the departures call. A detailsReference is only valid during the same day as it was generated.")], stop_point_gid : StrictStr, includes : Annotated[Optional[conlist(VTApiPlaneraResaWebV4ModelsDepartureDetailsIncludeType)], Field(description="The additional information to include in the response.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Returns details about a departure.  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_departures_details_reference_details_get_with_http_info(details_reference, stop_point_gid, includes, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method stop_points_stop_point_gid_departures_details_reference_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def stop_points_stop_point_gid_departures_get(self, stop_point_gid : Annotated[StrictStr, Field(..., description="The 16-digit Västtrafik gid of the stop point.")], start_date_time : Annotated[Optional[StrictStr], Field(description="The start of the time interval for which to get upcoming departures. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.")] = None, time_span_in_minutes : Annotated[Optional[StrictInt], Field(description="The number of minutes from the start time for which to get upcoming departures. Allowed values are between 0 and 1440.")] = None, max_departures_per_line_and_direction : Annotated[Optional[StrictInt], Field(description="The maximum number of departures for a single line in a specific direction.")] = None, limit : Annotated[Optional[StrictInt], Field(description="The number of results to return.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The zero-based start offset of the pagination.")] = None, include_occupancy : Annotated[Optional[StrictBool], Field(description="Includes occupancy in departure.")] = None, direction_gid : Annotated[Optional[StrictStr], Field(description="Filter result by last stop on journey. Must be a 16-digit Västtrafik stop area")] = None, **kwargs) -> VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetDeparturesResponse:  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_departures_get(stop_point_gid, start_date_time, time_span_in_minutes, max_departures_per_line_and_direction, limit, offset, include_occupancy, direction_gid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the stop_points_stop_point_gid_departures_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.stop_points_stop_point_gid_departures_get_with_http_info(stop_point_gid, start_date_time, time_span_in_minutes, max_departures_per_line_and_direction, limit, offset, include_occupancy, direction_gid, **kwargs)  # noqa: E501

    @validate_arguments
    def stop_points_stop_point_gid_departures_get_with_http_info(self, stop_point_gid : Annotated[StrictStr, Field(..., description="The 16-digit Västtrafik gid of the stop point.")], start_date_time : Annotated[Optional[StrictStr], Field(description="The start of the time interval for which to get upcoming departures. Must be specified in RFC 3339 format or be null which means that the current time on the server is used.")] = None, time_span_in_minutes : Annotated[Optional[StrictInt], Field(description="The number of minutes from the start time for which to get upcoming departures. Allowed values are between 0 and 1440.")] = None, max_departures_per_line_and_direction : Annotated[Optional[StrictInt], Field(description="The maximum number of departures for a single line in a specific direction.")] = None, limit : Annotated[Optional[StrictInt], Field(description="The number of results to return.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The zero-based start offset of the pagination.")] = None, include_occupancy : Annotated[Optional[StrictBool], Field(description="Includes occupancy in departure.")] = None, direction_gid : Annotated[Optional[StrictStr], Field(description="Filter result by last stop on journey. Must be a 16-digit Västtrafik stop area")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Returns departures from the specified stop point at the specified time.  # noqa: E501
        ...
        >>> thread = api.stop_points_stop_point_gid_departures_get_with_http_info(stop_point_gid, start_date_time, time_span_in_minutes, max_departures_per_line_and_direction, limit, offset, include_occupancy, direction_gid, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method stop_points_stop_point_gid_departures_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
